...
<body class="bg-stone-50 text-stone-900 antialiased min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <p class="text-center text-xs text-stone-400 mt-6">&copy; <?php echo e(date('Y')); ?> Fix Advertising. Internal use only.</p>
    </div>

</body>
</html>
<?php /**PATH C:\Users\NIzar Hasdian\Documents\fixads-laravel\fixads\resources\views/auth/login.blade.php ENDPATH**/ ?>