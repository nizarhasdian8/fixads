...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Fix Advertising</title>
    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: false }">
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('dashboard') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
                ...
                <a href="<?php echo e(route('pesanan.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('pesanan.*') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
                ...
                <a href="<?php echo e(route('produk.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('produk.*') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
                ...
                <a href="<?php echo e(route('bahan-baku.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('bahan-baku.*') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
                ...
                <a href="<?php echo e(route('pengajuan.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('pengajuan.*') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
                ...
                <a href="<?php echo e(route('bahan-masuk.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition <?php echo e(request()->routeIs('bahan-masuk.*') ? 'bg-brand-50 text-brand-700' : 'text-stone-600 hover:bg-stone-100'); ?>">
            ...
            <div class="border-t border-stone-200 p-3">
                ...
                <div class="flex items-center gap-3 px-2 py-2">
                    <div class="w-9 h-9 rounded-full bg-stone-200 flex items-center justify-center shrink-0">
                        <span class="text-xs font-semibold text-stone-600"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-stone-900 truncate"><?php echo e(auth()->user()->name); ?></p>
                        <p class="text-xs text-stone-400 truncate"><?php echo e(auth()->user()->roleLabel()); ?></p>
                    </div>
                </div>
...
</html><?php /**PATH C:\Users\NIzar Hasdian\Documents\fixads-laravel\fixads\resources\views/layouts/app.blade.php ENDPATH**/ ?>