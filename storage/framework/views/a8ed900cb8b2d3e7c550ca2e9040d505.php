...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <a href="<?php echo e(route('produk.create')); ?>" class="inline-flex items-center justify-center gap-2 bg-brand-500 hover:bg-brand-600 text-white font-semibold text-sm px-4 py-2.5 rounded-xl transition shadow-sm shadow-brand-500/20 shrink-0">
...
<form method="GET" class="bg-white border border-stone-200 rounded-2xl p-4 mb-6">
    <div class="relative">
        ...
        <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Cari nama atau kode produk..."
...
<div class="bg-white border border-stone-200 rounded-2xl overflow-hidden">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-stone-100">
                ...
                <tr class="hover:bg-stone-50">
                    <td class="px-5 py-3.5 font-medium text-stone-900"><?php echo e($item->kode_produk); ?></td>
                    <td class="px-5 py-3.5 text-stone-700"><?php echo e($item->nama_produk); ?></td>
                    <td class="px-5 py-3.5 text-stone-500 max-w-xs truncate"><?php echo e($item->deskripsi ?? '—'); ?></td>
                    ...
                    <td class="px-5 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-3">
                            <a href="<?php echo e(route('produk.edit', $item)); ?>" class="text-stone-400 hover:text-brand-600 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                            </a>
                            <form method="POST" action="<?php echo e(route('produk.destroy', $item)); ?>" onsubmit="return confirm('Hapus produk ini?')">
    ...
    <div class="px-5 py-4 border-t border-stone-100"><?php echo e($produk->links()); ?></div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NIzar Hasdian\Documents\fixads-laravel\fixads\resources\views/produk/index.blade.php ENDPATH**/ ?>