        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="text-left text-xs text-stone-400 uppercase tracking-wide border-b border-stone-100">
                    ...
                    <th class="px-5 py-3 font-medium">Nama Supplier</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-stone-100">
                ...
                <tr class="hover:bg-stone-50">
                    ...
                    <td class="px-5 py-3.5 text-stone-600">+{{ floatval($item->jumlah) }} {{ $item->bahanBaku->satuan }}</td>
                    <td class="px-5 py-3.5 text-stone-600">{{ $item->nama_supplier ?? '—' }}</td>
                </tr>
                @empty
                <tr><td colspan="5" class="px-5 py-10 text-center text-stone-400">Belum ada riwayat bahan masuk pada bulan ini.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
