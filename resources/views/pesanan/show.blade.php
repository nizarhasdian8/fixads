    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white border border-stone-200 rounded-2xl p-6">
            ...
            <dl class="grid sm:grid-cols-2 gap-y-4 gap-x-6 text-sm">
                ...
                {{-- BUKTI PEMBAYARAN: dinamis tergantung apakah order ini pernah DP atau langsung Lunas --}}
                @if($pesanan->status_pembayaran === 'DP' || $pesanan->bukti_pelunasan)
                    {{-- Kasus DP -> tampilkan bukti DP dan bukti pelunasan (kalau sudah ada) --}}
                    <div class="sm:col-span-2">
                        ...
                        <dd class="text-stone-900 font-medium mt-0.5">
                            ...
                            @else
                                <span class="text-stone-500">Tidak ada bukti DP</span>
                            @endif
                        </dd>
                    </div>
                ...
                @if($pesanan->status_pembayaran === 'DP')
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="nominal_pelunasan" value="{{ old('nominal_pelunasan', $sisaPembayaran) }}" min="1" class="w-full px-3.5 py-2.5 rounded-xl border border-stone-300 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition @error('nominal_pelunasan') border-red-400 @enderror">
